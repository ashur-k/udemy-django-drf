...
class CustomUserManager(BaseUserManager):
    ...
    def email_validator(self, email):
        try:
            ...
            raise ValueError(_("You must provide a vald email address."))
    ...
    def create_user(self, username, first_name, last_name, email, password, **extra_fields):
        ...
        if not first_name:
            raise ValueError(_("Users must submit a user first name."))
        
        if not last_name:
            raise ValueError(_("Users must submit a user last name."))
