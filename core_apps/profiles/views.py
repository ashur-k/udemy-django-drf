...
from .exceptions import CantFollowYourself, NotYourProfile, NotValidData
...
class ProfileDetailAPIView(generics.RetrieveAPIView):
    ...
    def retrieve(self, request, username, *args, **kwargs):
        try:
            ...
            raise NotFound("A profile with this user name does not exist!")
...
class FollowUnfollowAPIView(generics.GenericAPIView):
    ...
    def get(self, request, username):
        ...
        serailizer = ProfileSerializer(my_following_list, many=True)
        formatted_response = {
            "status_code": status.HTTP_200_OK,
            "users_i_follw": serailizer.data,
            "num_users_i_follow": len(serailizer.data)
        }
        return Response(formatted_response, status=status.HTTP_200_OK)
