    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=250, verbose_name='user')),
                ('slug_field', autoslug.fields.AutoSlugField(always_update=True, editable=False, populate_from='title', unique=True)),
                ('description', models.CharField(max_length=255, verbose_name='description')),
                ('body', models.TextField(blank=True, verbose_name='article content')),
