...
class ArticleFilter(filters.FilterSet):
    author = filters.CharFilter(field_name="author_first_name", lookup_expr="icontains")
    title = filters.CharFilter(field_name="author__first_name", lookup_expr="icontains")
